...
export function* fetchDevices() {
  try {
    let result = yield call(() => callAPI({ url: "/api/get", method: "GET" }));
...
export function* changePage(newActivePage) {
  yield put(changeActivePage(newActivePage.body));
}
...
export default function* rootSaga() {
  ...
  yield takeEvery(sagaActions.CHANGE_PAGE, changePage);
}
